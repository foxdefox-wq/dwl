...
static const char *sobercutcmd[] = { "sh", "-c", "sudo /home/fox/sober-cut.sh", NULL };
...
static const Key keys[] = {
	...
	{ 0, XKB_KEY_XF86AudioRaiseVolume,   spawn, {.v = (const char*[]){"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "1%+", NULL}} },
	{ 0, XKB_KEY_XF86AudioLowerVolume,   spawn, {.v = (const char*[]){"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "1%-", NULL}} },
